...
`,E=S(()=>{const i=g(),{step:e,timeLeft:n,timerOn:s}=l;return h.useEffect(()=>{let a;return s&&e==="WALK"&&n>0&&(a=setInterval(()=>l.onSetTimeLeft(),1e3)),()=>clearInterval(a)},[s,e,n]),o.jsxs(R,{children:[o.jsx(_,{onClick:()=>{l.onCloseGame(),i("/brain-games")}}),e==="MISSION"&&n!==0&&o.jsx(k,{}),e==="WALK"&&n!==0&&o.jsx(v,{}),e==="QUIZ"&&n!==0&&o.jsx(O,{}),(e==="RESULT"||n===0)&&o.jsx(A,{}),!e||e==="START"&&o.jsx(w,{})]})}),q=Object.freeze(Object.defineProperty({__proto__:null,default:E},Symbol.toStringTag,{value:"Module"}));export{q as V,l as v};
