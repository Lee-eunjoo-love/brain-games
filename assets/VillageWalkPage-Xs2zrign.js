...
`,E=S(()=>{const i=g(),{step:e,timeLeft:o,timerOn:s}=l;return h.useEffect(()=>{let a;return s&&e==="WALK"&&o>0&&(a=setInterval(()=>l.onSetTimeLeft(),1e3)),()=>clearInterval(a)},[s,e,o]),n.jsxs(R,{children:[n.jsx(_,{onClick:()=>{l.onCloseGame(),i("/brain-games")}}),e==="MISSION"&&o!==0&&n.jsx(v,{}),e==="WALK"&&o!==0&&n.jsx(w,{}),e==="QUIZ"&&o!==0&&n.jsx(O,{}),(e==="RESULT"||o===0)&&n.jsx(A,{}),!e||e==="START"&&n.jsx(k,{})]})}),q=Object.freeze(Object.defineProperty({__proto__:null,default:E},Symbol.toStringTag,{value:"Module"}));export{q as V,l as v};
