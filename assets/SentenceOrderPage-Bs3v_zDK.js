...
`,S=w(()=>{const a=u(),[t,s]=l.useState(!1),{isLoading:e}=r;return l.useEffect(()=>(r.fetchData(),()=>{t||r.onCloseGame()}),[t]),e?n.jsx(c,{children:"Loading..."}):n.jsxs(c,{children:[n.jsx(v,{onClick:()=>{r.onCloseGame(),s(!0),a("/brain-games")}}),n.jsx(C,{})]})}),j=Object.freeze(Object.defineProperty({__proto__:null,default:S},Symbol.toStringTag,{value:"Module"}));export{j as S,r as s};
