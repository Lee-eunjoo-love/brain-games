...
`,_=j(()=>{const S=E(),{view:o}=f,[t,i]=y.useState(!1);return y.useEffect(()=>()=>{t||f.onCloseGame()},[t]),s.jsxs(O,{className:"bg-gray-200 dark:bg-gray-600",children:[s.jsx(N,{onClick:()=>{f.onCloseGame(),i(!0),S("/brain-games")}}),o==="MAIN"?s.jsx(R,{}):o==="LEVEL"?s.jsx(D,{}):s.jsx(G,{})]})}),B=Object.freeze(Object.defineProperty({__proto__:null,default:_},Symbol.toStringTag,{value:"Module"}));export{B as S,f as s};
