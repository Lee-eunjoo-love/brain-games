...
`,y=h(()=>{const{timeLeft:i}=a;return t.jsxs(C,{className:`timerBox ${i<=10?"time-is-ticking":""}`,children:["⏱ 남은 시간: ",i,"초"]})}),v=d.memo(y),k=l(()=>u(()=>import("./TimeoutResult-ClwpZdQ-.js"),__vite__mapDeps([0,1,2,3,4,5,6]))),G=l(()=>u(()=>import("./SuccessResult-Cf9impR7.js"),__vite__mapDeps([7,1,2,3,4,5,6]))),j=l(()=>u(()=>import("./StudyStep-DVNrkiYX.js"),__vite__mapDeps([8,1,2,3,4,5,9,6]))),T=f.div`
  padding: 20px;
  //margin: 0 auto;
