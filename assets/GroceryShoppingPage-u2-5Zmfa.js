...
`,_=g(()=>{const{timeLeft:s}=i;return o.jsxs(P,{className:`timerBox ${s<=10?"time-is-ticking":""}`,children:["⏱ 남은 시간: ",s,"초"]})}),v=u.memo(_),y=d(()=>c(()=>import("./TimeoutResult-Ce7owdLr.js"),__vite__mapDeps([0,1,2,3,4,5]))),C=d(()=>c(()=>import("./SuccessResult-CgCewiPp.js"),__vite__mapDeps([6,1,2,3,4,5]))),k=d(()=>c(()=>import("./StudyStep-DmEuMTHc.js"),__vite__mapDeps([7,1,2,3,4,5]))),j=p.div`
  padding: 20px;
  //margin: 0 auto;
