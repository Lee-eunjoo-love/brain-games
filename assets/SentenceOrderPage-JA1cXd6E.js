...
`,L=b(()=>{const a=h(),{isLoading:e}=r;return u.useEffect(()=>{r.fetchData()},[]),e?n.jsx(c,{children:"Loading..."}):n.jsxs(c,{children:[n.jsx(w,{onClick:()=>{r.onCloseGame(),a("/brain-games")}}),n.jsx(C,{})]})}),D=Object.freeze(Object.defineProperty({__proto__:null,default:L},Symbol.toStringTag,{value:"Module"}));export{D as S,r as s};
