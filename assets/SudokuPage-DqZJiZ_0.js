...
`,O=N(()=>{const x=M(),{view:o}=S;return s.jsxs(D,{className:"bg-gray-200 dark:bg-gray-600",children:[s.jsx(C,{onClick:()=>{S.onCloseGame(),x("/brain-games")}}),o==="MAIN"?s.jsx(P,{}):o==="LEVEL"?s.jsx(R,{}):s.jsx(v,{})]})}),L=Object.freeze(Object.defineProperty({__proto__:null,default:O},Symbol.toStringTag,{value:"Module"}));export{L as S,S as s};
