...
`,de=ne(()=>{const y=re(),F=ce().locale("ko"),{levels:N,level:j,palette:_}=L,T=U.useCallback(()=>{L.onChangeScreen("STUDY"),L.onResetTimeLeft()},[]),g=U.useCallback(l=>{L.onSetLevel(l),L.onResetTimeLeft(),L.onResetList(l)},[]),v=U.useMemo(()=>{const l=F.get("hour");return l>6&&l<=12?"아침":l>12&&l<=14?"점심":l>14&&l<=17?"오후":l>17&&l<=20?"저녁":"밤"},[F]);return c.jsxs(le,{children:[c.jsxs("header",{className:"header min-w-[calc(450px)]",children:[c.jsx("div",{className:"flex justify-end",children:c.jsx("button",{className:"p-2 text-gray-500 rounded-full hover:bg-gray-100 hover:text-gray-700",style:{backgroundColor:"transparent",border:"none"},onClick:()=>{g(1),y("/brain-games")},children:c.jsx("svg",{xmlns:"www.w3.org",fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"w-6 h-6",children:c.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M6 18L18 6M6 6l12 12"})})})}),c.jsx("h1",{style:{color:_.primary},children:"기억 쏙쏙"}),c.jsxs("p",{className:"subtitle",style:{color:_.secondary},children:["복남 어르신, 참 좋은",c.jsx("span",{className:"font-bold text-stone-500 ml-2",children:v}),"입니다."]})]}),c.jsxs("main",{className:"min-w-[calc(450px)]",children:[c.jsx("ul",{className:"flex items-center justify-end",children:N&&N.map(l=>l===j?c.jsx("li",{className:"bg-orange-400 text-white rounded-3xl mr-1 w-10 h-10 flex items-center justify-center text-2xl",children:l},l):c.jsx("li",{className:"bg-teal-500 text-white rounded-3xl mr-1 w-10 h-10 flex items-center justify-center text-2xl cursor-pointer",onClick:()=>g(l),children:l},l))}),c.jsxs("button",{className:"main-btn",style:{backgroundColor:_.primary},onClick:T,children:[c.jsx("span",{style:{fontSize:"48px"},children:"🌳"}),c.jsx("h2",{style:{fontSize:"28px",margin:"10px 0"},children:"오늘의 뇌 비타민 충전 시작"}),c.jsx("p",{children:"딱 5분이면 충분해요!"})]}),c.jsxs("div",{className:"grid",children:[c.jsx("div",{className:"sub-card",onClick:()=>y("/brain-games/shopping"),children:c.jsx("span",{className:"text-stone-700",children:"🛒 시장 가기"})}),c.jsxs("div",{className:"sub-card",onClick:()=>y("/brain-games/sudoku",{replace:!0}),children:["📸 ",c.jsx("span",{className:"text-stone-700",children:"스도쿠"})]}),c.jsxs("div",{className:"sub-card",onClick:()=>y("/brain-games/walk",{replace:!0}),children:["🧭 ",c.jsx("span",{className:"text-stone-700",children:"동네 한바퀴"})]}),c.jsxs("div",{className:"sub-card",onClick:()=>alert("준비중입니다."),children:["📰 ",c.jsx("span",{className:"text-stone-700",children:"준비중"})]})]})]})]})}),pe=U.memo(de);export{pe as default};
