...
`,C=b(()=>{const a=h(),{isLoading:e}=r;return u.useEffect(()=>{r.fetchData()},[]),e?n.jsx(c,{children:"Loading..."}):n.jsxs(c,{children:[n.jsx(v,{onClick:()=>{r.onCloseGame(),a("/brain-games")}}),n.jsx(y,{})]})}),z=Object.freeze(Object.defineProperty({__proto__:null,default:C},Symbol.toStringTag,{value:"Module"}));export{z as S,r as s};
