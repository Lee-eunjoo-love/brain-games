...
`,_=g(()=>{const{timeLeft:s}=i;return o.jsxs(P,{className:`timerBox ${s<=10?"time-is-ticking":""}`,children:["⏱ 남은 시간: ",s,"초"]})}),v=u.memo(_),y=d(()=>c(()=>import("./TimeoutResult-CJDbBwfK.js"),__vite__mapDeps([0,1,2,3,4,5,6]))),C=d(()=>c(()=>import("./SuccessResult-X7u-Xw2l.js"),__vite__mapDeps([7,1,2,3,4,5,6]))),k=d(()=>c(()=>import("./StudyStep-4tCgmwxN.js"),__vite__mapDeps([8,1,2,3,4,5,9,6]))),j=p.div`
  padding: 20px;
  //margin: 0 auto;
